<template>
  <section
    id="testimonial"
    class="section bg-primary position-relative testimonial-bg-shapes scroll-top"
  >
    <div class="container">
      <div class="row">
    ...
    />
    <img
      src="~/assets/images/illustrations/dots-group-v.png"
      alt="bg-shape"
    ...
    />
    <img
      src="~/assets/images/illustrations/leaf-cyan.png"
      alt="bg-shape"
